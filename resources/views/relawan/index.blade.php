...
<div class="kontaner ml-3">
  ...
  <div class="judul text-center">
    <h1 class="text-center mb-4 mt-5 text-bold">Kontituante</h1>
  </div>
      ...
      <div class="row text-center">
        <div class="input-group mt-3">
          <form action="/relawan" method="GET">
            <input type="search" id="inputPassword6" placeholder="Cari Konstituante" name="search" class="form-control ml-3 mt-3" aria-describedby="passwordHelpInline">
          </form>
